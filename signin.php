				...
				if ($email_check == 0) {
					//if($u_mobile == 10){
						if (strlen($_POST['password']) >1 ) {
							...
							$_SESSION['username'] = $u_fname;
							
							$sql = "INSERT INTO user (firstName,lastName,email,mobile,address,password) VALUES ('$_POST[first_name]','$_POST[last_name]','$_POST[email]','$_POST[mobile]','$_POST[signupaddress]','$_POST[password]')" or die("Query Failed");
							$result = mysqli_query($con,$sql);
							if ($result) {
								$success_message = '<script>alert("Welcome to JustiGet"); window.location="login.php"</script>
					...
					// }else{
					// 	throw new Exception ('Enter Right Mobile Number');
					// }
				}else {
...
<html>
	<head>
		<title>Welcome to JustiGet </title>
	...
	<body class="home-welcome-text" style="background-image: url(image/homebackgrndimg2.png);">
		<div class="homepageheader" style="position: inherit;">
			...
			<div style="float: left; margin: 5px 0px 0px 23px;">
				<a href="index.php">
					<img style=" height: 75px; width: 130px;" src="image/JustigetLogo.png">
				</a>
			</div>
			<div class="">
				<div id="srcheader">
