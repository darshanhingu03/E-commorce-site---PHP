...
if (((@$_FILES['profilepic']['type']=='image/jpeg') || (@$_FILES['profilepic']['type']=='image/png') || (@$_FILES['profilepic']['type']=='image/jpg') || (@$_FILES['profilepic']['type']=='image/gif'))) {
...
//triming name
	$getposts1 = mysqli_query($con,"SELECT pid FROM orders WHERE pid='$epid'") or die(mysql_error());
